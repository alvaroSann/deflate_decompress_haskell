...
/* package deflate-decompress-0.1.0.0 */
#ifndef VERSION_deflate_decompress
#define VERSION_deflate_decompress "0.1.0.0"
#endif /* VERSION_deflate_decompress */
#ifndef MIN_VERSION_deflate_decompress
#define MIN_VERSION_deflate_decompress(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_deflate_decompress */
...
#define CURRENT_PACKAGE_KEY "deflate-decompress-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "deflate-decompress-0.1.0.0-inplace"
